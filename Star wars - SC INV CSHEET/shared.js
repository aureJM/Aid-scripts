...
const WEAPONS = [
  ...
  "sporting blaster", "light repeating blaster", "spear", "eWeb repeating blaster", "axe", "jawa ionization blaster",
...
const CLOTHING = [
  ...
  "haxion brood bounty hunter armor", "quantum crystalline armor", "cortosis weave armor", "mandalorian armor of beskar",
...
let possibleLines = [
  ...
  'It is a period of civil war. Scum rebel spaceships, striking from a hidden base, have won their first victory against the glory Galactic Empire.\n',
  `It is a period of civil war. The rebels and the empire is in war. you just want to know that you can take advantage of this.\n`,
];
...
const parseClass = (character) => {
  ...
  switch (charClass) {
    case 'mercenary':
      addToInventory('light repeating blaster', 1);
      addToInventory('mercenary armor', 1);
      equipItem('light repeating blaster');
      equipItem('mercenary armor');
      break;
    case 'spacer':
      addToInventory('blaster', 1);
      addToInventory('spacer armor', 1);
      equipItem('blaster');
      equipItem('spacer armor');
      break;
    case 'smuggler':
      addToInventory('blaster', 1);
      addToInventory('smuggler armor', 1);
      equipItem('blaster');
      equipItem('smuggler armor');
      break;
    case 'merchant':
      addToInventory('blaster', 1);
      addToInventory('merchant armor', 1);
      equipItem('blaster');
      equipItem('merchant armor');
      break;
    case 'soldier':
      addToInventory('light repeating blaster', 1);
      addToInventory('soldier armor', 1);
      equipItem('light repeating blaster');
      equipItem('soldier armor');
      break;
    case 'assassin':
      addToInventory('jawa ionization blaster', 1);
      addToInventory('assassin armor', 1);
      equipItem('jawa ionization blaster');
      equipItem('assassin armor');
      break;
      case 'crime lord':
        addToInventory('blaster', 1);
        addToInventory('crime lord armor', 1);
        equipItem('blaster');
        equipItem('crime lord armor');
        break;
      case 'jedi':
        addToInventory('lightsaber', 1);
        addToInventory('jedi apparel', 1);
        equipItem('lightsaber');
        equipItem('jedi apparel');
        break;
      case 'sith':
        addToInventory('lightsaber', 1);
        addToInventory('sith apparel', 1);
        equipItem('lightsaber');
        equipItem('sith apparel');
        break;
      case 'androids':
        addToInventory('light repeating blaster', 1);
        addToInventory('bounty hunter armor', 1);
        equipItem('light repeating blaster');
        equipItem('bounty hunter armor');
        break;
      case 'mandalorian':
        addToInventory('amban sniper rifle', 1);
        addToInventory('mandalorian armor of beskar', 1);
        equipItem('amban sniper rifle');
        equipItem('mandalorian armor of beskar');
        break;
      case 'bounty hunter':
        addToInventory('light repeating blaster', 1);
        addToInventory('haxion brood bounty hunter armor', 1);
        equipItem('light repeating blaster');
        equipItem('haxion brood bounty hunter armor');
        break;
      case 'slaver':
        addToInventory('vibroblade', 1);
        addToInventory('slaver armor', 1);
        equipItem('vibroblade');
        equipItem('slaver armor');
        break;
    default:
